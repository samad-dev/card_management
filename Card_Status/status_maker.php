...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // ✅ Required Fields
    $required_fields = ['status_types', 'card_number', 'current_card_status', 'new_card_status'];
    ...
    // ✅ Insert Query
    $query = "INSERT INTO card_status (status_types, card_number, current_card_status, new_card_status) 
              VALUES (?, ?, ?, ?)";
    $stmt = $db->prepare($query);
    $stmt->bind_param("siss", $status_types, $card_number, $current_card_status, $new_card_status);
